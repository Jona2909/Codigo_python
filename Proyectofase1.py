...
def finalizar():
    ...
    cap.release()
    cv2.destroyAllWindows()
    # Eliminar la imagen actual de la etiqueta lblVideo
    lblVideo.configure(image="")
    lblVideo.image = None
    # Eliminar la imagen actual de la etiqueta lblVideo2
    lblVideo2.configure(image="")
    lblVideo2.image = None
...
#boton
boton = Button(pantalla, text="Colores en la imagen",height="1", width="18",bg="#624e57",fg="white", font=fuente, command=update_image)
